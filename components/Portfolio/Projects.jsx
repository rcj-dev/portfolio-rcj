...
const Projects = (props) => {
  ...
  return (
    <>
      <div className="w-full sm:w-[95%] md:w-[95%] lg:w-[95%] xl:w-[110%] relative h-60 hover:scale-105 transition-all duration-300 overflow-hidden group cursor-pointer" onClick={openModal}>
        <img src={props.images[0]} alt="Project" className="absolute w-full h-full object-cover"/>
        ...
        <h1 className="fira-code absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center text-white text-lg w-full px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300"> ver mais </h1>
      </div>

      {isOpen && (
        <div className="fira-code fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.4)] backdrop-blur-sm z-50 p-4" onClick={handleClickOutside}>
          <div
            ref={modalRef}
